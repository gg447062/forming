...
function FAQ() {
  return (
    <div>
      <header>
        <p class="text-large blue">Forming FAQ</p>
        <a class="text-large sm-hide" href="/">
          Back
        </a>
      </header>
      <section id="faq">
        <div>
          <p class="faq-title">What type of music do you showcase?</p>
          <p>We showcase DJ + Live sets of almost any genre!</p>
        </div>
        <div>
          <p class="faq-title">Can I use a music video?</p>
          <p>
        ...
        <div>
          <p class="faq-title">What type of visuals should I use?</p>
          <p>
        ...
        <div>
          <p class="faq-title">Why can’t I stream live?</p>
          <p>
        ...
        <div>
          <p class="faq-title">How long should submissions be?</p>
          <p>Please aim to keep your video 10 minutes long or less.</p>
        </div>
        <div>
          <p class="faq-title">How should I submit my file?</p>
          <p>
        ...
        <div>
          <p class="faq-title">Where will the event happen?</p>
          <p>
            At the
        ...
        <div>
          <p class="faq-title">Will I get paid?</p>
          <p>
        ...
        <div>
          <p class="faq-title">How much will I get paid?</p>
          <p>
        ...
        <div>
          <p class="faq-title">When do I get paid?</p>
          <p>
